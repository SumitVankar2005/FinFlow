-- Postgres schema for FinFlow (converted from MySQL schema.sql)
-- Run this once against your Neon database. Neon already gives you a database
-- when you create a project, so there's no CREATE DATABASE / USE step needed.

DROP TABLE IF EXISTS Flag_Assignments CASCADE;
DROP TABLE IF EXISTS Subscription_Flags CASCADE;
DROP TABLE IF EXISTS Subscriptions CASCADE;
DROP TABLE IF EXISTS Loans_Purchases CASCADE;
